...
contract MysticDexV1 is IDEX {
    ...
    function swap(
        ...
        bool deposit = sellToken.transferFrom(
            msg.sender,
            address(this),
            sellAmount
        );
    ...
    function addLiquidity(
        uint256 maxAmount0,
        uint256 maxAmount1
    ) external override returns (uint256 poolShares) {
        ...
        if (s_liquidity0 == 0 || s_liquidity1 == 0) {
            ...
            (optAmount0, optAmount1) = calculateCPLiquidityReq(
                maxAmount0,
                maxAmount1
            );
        }
    ...
    function withdrawLiquidity(
        ...
        s_liquidity0 -= amount0;
        s_liquidity1 -= amount1;
    ...
    function calculateCPLiquidityReq(
        uint256 maxAmount0,
        uint256 maxAmount1
    ) private view returns (uint256 optAmount0, uint256 optAmount1) {
